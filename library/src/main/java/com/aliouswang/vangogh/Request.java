...
public final class Request {
    ...
    public final float rotationDegress;
    ...
    public final Vangogh.Priority priority;
    ...
    private Request(Uri uri, int resourceId, String stableKey, List<Transformation> transformations,
                    ...
                    boolean onlyScaleDown, float rotationDegress, float rotationPivotX, float rotationPivotY,
                    boolean hasRotationPivot, boolean purgeable, Bitmap.Config config, Vangogh.Priority priority) {
        this.uri = uri;
    ...
    public String toString() {
        ...
        if (rotationDegress != 0) {
            builder.append(" rotation(").append(rotationDegress);
            if (hasRotationPivot) {
    ...
    boolean needsMatrixTransform() {
        return hasSize() || rotationDegress != 0;
    }
    ...
    public static final class Builder {
        ...
        private Vangogh.Priority priority;
        ...
        private Builder(Request request) {
            ...
            rotationDegrees = request.rotationDegress;
        ...
        public Builder priority(@NonNull Vangogh.Priority priority) {
            if (priority == null) {
        ...
        public Request build() {
            ...
            if (priority == null) {
                priority = Vangogh.Priority.NORMAL;
            }
